...
function Register({ submit, handlePage, setError, error }) {
    ...
    return (
        <div>
            {error && <div className="text-danger text-center font-weight-bold mb-3">{error===true ? 'Something wrong! Try later' : error}</div>}
            ...
            <form className="row" onSubmit={handleSubmit(submit)}>
                ...
                <div className="col-12 mt-3">
                    ...
                    <h6 className="text-light text-center mt-4" style={{ fontSize: "0.9rem", opacity: 0.85 }}>Already have an account?{" "}
